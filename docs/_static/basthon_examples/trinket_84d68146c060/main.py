...
for r in range(antall_runder):
    ...
    for k in range(antall_kamper_per_runde):
        # TODO: Oppgave 4c): Bytt om på hjemme og borte i partallsrunder
        kamp = hjemmelag[k] + bindestrek + bortelag[k]
        runde.append(kamp) # legg til kamp i indre liste
    # TODO: Oppgave 4a): Roter listene ved å flytte lag mellom dem
    # TODO: Oppgave 4b): Endre det du gjorde i 4a) for å holde ett lag statisk
